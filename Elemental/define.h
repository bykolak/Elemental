...
enum SPRITE_STATUS{ SPRITE_NOT_ACTIVE, SPRITE_DEAD, SPRITE_MOVE, SPRITE_ATTACK,  SPRITE_HURT, SPRITE_DYING, SPRITE_PRIMARY_SKILL,SPRITE_SECONDARY_SKILL,SPRITE_ULTIMATE_SKILL,SPRITE_IDLE, MAX_SPRITE_STATUS };
#endif
