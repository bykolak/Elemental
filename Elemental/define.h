...
const int IDLE_WAIT = 120; //number of ticks before animation fires
...
enum KEYS { UP, DOWN, LEFT, RIGHT,OPEN, MAX_KEYS };
...
enum EDITOR{CLEAR_TILE,CLEAR_OBJECT,CREATE_FLOOR,CREATE_WALL,CREATE_DOOR};
enum SPRITE_STATUS{ SPRITE_MOVE, SPRITE_ATTACK, SPRITE_DEFEND, SPRITE_HURT, SPRITE_DYING, SPRITE_PRIMARY_SKILL,SPRITE_SECONDARY_SKILL,SPRITE_ULTIMATE_SKILL,SPRITE_IDLE, MAX_SPRITE_STATUS };
#endif
