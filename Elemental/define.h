...
enum EDITOR{ CLEAR_TILE, CLEAR_OBJECT,CLEAR_SPRITE, CREATE_FLOOR, CREATE_WALL, CREATE_DOOR, CREATE_SPRITE_0, CREATE_SPRITE_1, CREATE_SPRITE_2, CREATE_SPRITE_3, CREATE_SPRITE_4, CREATE_SPRITE_5, CREATE_DECORATION,DECREASE_HP,INCREASE_HP,INCREASE_SPRITE,DECREASE_SPRITE,SELECT_SPRITE, LOAD_MAP, SAVE_MAP,MAX_KEYS };
