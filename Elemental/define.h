...
enum SPRITE_TYPE{ THORWAL, WEREBULL, CRYSTAL,AMFIR,ENEMY_0, ENEMY_1,ENEMY_2, ENEMY_3, ENEMY_4, ENEMY_5, ENEMY_6, ENEMY_7,EMPTY_SPRITE};
...
enum EDITOR{ CLEAR_TILE, CLEAR_OBJECT,CLEAR_SPRITE, CREATE_FLOOR, CREATE_WALL, CREATE_DOOR, CREATE_SPRITE_0, CREATE_SPRITE_1, CREATE_SPRITE_2, CREATE_SPRITE_3, CREATE_SPRITE_4,CREATE_DECORATION,DECREASE_HP,INCREASE_HP,INCREASE_SPRITE,LOAD_MAP,SAVE_MAP,DECREASE_SPRITE,MAX_KEYS };
