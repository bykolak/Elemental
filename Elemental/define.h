...
#define DEGREE_1 0.01745329252
#define DEGREE_3 0.05235987756
#define DEGREE_9 DEGREE_1 * 9
...
const int IDLE_Y = 64;// 256;
const int DEAD_X = 768;
const int DEAD_Y = 0;
const int SKILL_SIZE = 96;
const int PRIMARY_SKILL_X = 0;
const int SECONDARY_SKILL_X = 384;
const int PRIMARY_SKILL_Y = 64;//256;
const int SECONDARY_SKILL_Y = 64;//256;
const int ULTIMATE_SKILL_X = 768;
const int ULTIMATE_SKILL_Y = 64;//256;
const int SPRITESHEET_Y = 128;// 512;
...
enum STYLE_OBJECT{	NO_STYLE, DOOR_0, DOOR_1, DOOR_2, DOOR_3, DOOR_4, TRAP_0, TRAP_1, TRAP_2, TRAP_3, TRAP_4,//exact texture of .object
				ENTRANCE_TILE, EXIT_TILE, BARREL_0, DECORATION_1, DECORATION_2, DECORATION_3,
...
enum OBJECT_STATUS{OBJECT_NOT_ACTIVE,OBJECT_ACTIVE};
enum SPRITE_TYPE{ THORWAL, WEREBULL, CRYSTAL, AMFIR, GOBLIN, SKELETON,ENEMY_2, ENEMY_3, ENEMY_4, ENEMY_5, ENEMY_6, ENEMY_7, EMPTY_SPRITE};
...
enum EDITOR{ CLEAR_TILE, CLEAR_OBJECT,CLEAR_SPRITE, CREATE_FLOOR, CREATE_WALL, CREATE_DOOR, CREATE_SPRITE_0, CREATE_SPRITE_1, CREATE_SPRITE_2, CREATE_SPRITE_3, CREATE_SPRITE_4, CREATE_SPRITE_5, CREATE_DECORATION,DECREASE_HP,INCREASE_HP,INCREASE_SPRITE,DECREASE_SPRITE,SELECT_SPRITE, LOAD_MAP, SAVE_MAP,FACE_VERTICAL,FACE_HORIZONTAL,MAX_KEYS };
enum SPRITE_STATUS{ SPRITE_NOT_ACTIVE, SPRITE_DEAD, SPRITE_MOVE, SPRITE_ATTACK,  SPRITE_HURT, SPRITE_DYING, SPRITE_PRIMARY_SKILL,SPRITE_SECONDARY_SKILL,SPRITE_ULTIMATE_SKILL,SPRITE_IDLE,SPRITE_ROTATE, MAX_SPRITE_STATUS };
#endif
